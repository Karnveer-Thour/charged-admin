...
const Pricing: React.FC = () => {
  ...
  const handlePricingChange = (id: string, field: keyof PricingRule, value: any) => {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" color="text.secondary" paragraph>
        Configure pricing rules for different ride types including base prices, per-kilometer rates, 
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'basePrice', e.target.value)}
                      />
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'pricePerKm', e.target.value)}
                      />
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'pricePerMinute', e.target.value)}
                      />
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'cancellationFee', e.target.value)}
                      />
                    </Grid>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'refundEligibilityDistance', e.target.value)}
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'minimumBillableDistance', e.target.value)}
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        onChange={(e) => handlePricingChange(rule.id, 'commissionPercentage', e.target.value)}
